package com.pull2me.android.uri;
...
public class UriUtils {
     ...
     * @return
     */
    public static URI append(URI base, String extension) throws URISyntaxException {
    ...
    public static boolean sameURI(URI url1, URI url2) {
        ...
        return file1 != null && file1.equals(toFile(url2));
    }
    ...
    private static String toUnEncodedString(URI uri) {
